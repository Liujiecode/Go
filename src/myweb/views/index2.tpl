...
<script type="module">
	...
	function introCannon()
	{
		...
		cannonTL.to(steveEl, {y: '-=20', duration: 0.1, onComplete: () => {
			...
			textEl.textContent = "给你个大炮 ";
			textHighlightEl.textContent = "猪猫打它！";
    ...
    <div id="ui">
        <div class="positioner">
            ...
            <div class="speech-bubble">
                <div id="bubble">
                    <span id="text">猫猫，点亮你的圣诞！</span>
                    <span>你好{{.Website}},我去{{.Email}} </span>
                    <span id="text-highlight"></span>
                    <div id="next">Next</div>
                </div>
            </div>
    
                <img id="steve" src="https://assets.codepen.io/557388/happy.svg" alt="杰哥">
